<x-layouts.app title="Nieuwe Categorie Aanmaken">
    <style>
    ...
    <div class="form-container">
        <h1 style="text-align: center; margin-bottom: 2rem; color: #1f2937;">Nieuwe Categorie Aanmaken</h1>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-input" value="{{ old('name') }}" placeholder="Voer de categorienaam in" required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-textarea" placeholder="Beschrijf de categorie...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="btn-group">
                <button type="submit" class="btn primary">Categorie Aanmaken</button>
                <a href="{{ route('categories.index') }}" class="btn secondary">Annuleren</a>
            </div>
        </form>
    </div>
</x-layouts.app>